...
const DICT = {
  sq: {
    ...
    "auth.newPassword": "Fjalëkalimi i ri", "auth.updatePassword": "Ruaj fjalëkalimin",
    "auth.updated": "Fjalëkalimi u ndryshua.",
    ...
    "settings.goal": "Objektivi mujor (€)", "settings.goalHint": "Lëre bosh që të mos kesh objektiv.",
    "goal.label": "OBJEKTIVI", "goal.reached": "Objektivi u arrit! 🎉",
    "goal.needed": "{amount}/ditë për {days} ditët e mbetura",
    ...
    "insights.perHour": "€ për orë", "insights.bestWeekday": "Dita më fitimprurëse",
    "insights.weekdayRate": "{day}: {amount}/orë",
    "home.shiftStarted": "Turni nisi",

    "recap.title": "KJO JAVË", "recap.summary": "{amount} në xhep, {days} ditë punë.",
    "recap.best": "Më e mira: {day} ({amount})", "recap.none": "Ende s'ke punuar këtë javë.",
    "share.month": "Ndaj muajin", "share.daysWorked": "Ditë punë", "share.gross": "Bruto",
    "share.cut": "Pjesa ({percent}%)", "share.tips": "Bakshish", "share.total": "NË XHEP",
    "share.footer": "Raport privat i të ardhurave • Taksimetri",

    "sync.savedOffline": "U ruajt pa internet — sinkronizohet vetë kur të kthehet lidhja.",
    "sync.pending": "{count} në pritje për sinkronizim",
    "sync.done": "U sinkronizua ✓",
  ...
  sr: {
    ...
    "auth.newPassword": "Nova lozinka", "auth.updatePassword": "Sačuvaj lozinku",
    "auth.updated": "Lozinka je promenjena.",
    ...
    "settings.goal": "Mesečni cilj (€)", "settings.goalHint": "Ostavi prazno ako nemaš cilj.",
    "goal.label": "CILJ", "goal.reached": "Cilj postignut! 🎉",
    "goal.needed": "{amount}/dan za preostalih {days} dana",
    ...
    "insights.perHour": "€ po satu", "insights.bestWeekday": "Najbolji dan u nedelji",
    "insights.weekdayRate": "{day}: {amount}/sat",
    "home.shiftStarted": "Smena počela",

    "recap.title": "OVA NEDELJA", "recap.summary": "{amount} u džepu, {days} radnih dana.",
    "recap.best": "Najbolji: {day} ({amount})", "recap.none": "Još nema unosa ove nedelje.",
    "share.month": "Podeli mesec", "share.daysWorked": "Radnih dana", "share.gross": "Bruto",
    "share.cut": "Deo ({percent}%)", "share.tips": "Napojnice", "share.total": "U DŽEPU",
    "share.footer": "Privatni izveštaj o zaradi • Taksimetar",

    "sync.savedOffline": "Sačuvano bez interneta — sinhronizuje se samo kad se veza vrati.",
    "sync.pending": "{count} čeka sinhronizaciju",
    "sync.done": "Sinhronizovano ✓",
  ...
  en: {
    ...
    "auth.newPassword": "New password", "auth.updatePassword": "Save password",
    ...
    "settings.goal": "Monthly goal (€)", "settings.goalHint": "Leave empty for no goal.",
    "goal.label": "GOAL", "goal.reached": "Goal reached! 🎉",
    "goal.needed": "{amount}/day needed for the remaining {days} days",
    ...
    "insights.perHour": "€ per hour", "insights.bestWeekday": "Best weekday",
    "insights.weekdayRate": "{day}: {amount}/hr",
    "home.shiftStarted": "Shift started",

    "recap.title": "THIS WEEK", "recap.summary": "{amount} take-home over {days} days.",
    "recap.best": "Best: {day} ({amount})", "recap.none": "No work logged this week yet.",
    "share.month": "Share month", "share.daysWorked": "Days worked", "share.gross": "Gross",
    "share.cut": "Cut ({percent}%)", "share.tips": "Tips", "share.total": "TAKE-HOME",
    "share.footer": "Private earnings statement • Taxi Meter",

    "sync.savedOffline": "Saved offline — will sync by itself when you're back online.",
