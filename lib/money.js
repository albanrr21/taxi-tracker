...
/* ---------- User-typed amounts ----------
   iOS (and many Android) decimal keypads produce a COMMA in European
   locales, and <input type="number"> silently rejects it. Amount fields
   are therefore type="text" + inputMode="decimal": keep the keypad,
   accept both separators. */

// Keep an amount field to digits and separators while typing.
export const cleanAmount = (v) => String(v).replace(/[^0-9.,]/g, "");

// Parse what the driver typed: "12,50" and "12.50" both → 12.5.
